...
<body>
 <div style="background-color:Azure;text-align:right;">           <p class="view"><font size="2"><a href="login.jsp">登录</a>   <a href="register.jsp"> 注册</a></font> </p><hr/>
<div class="top2" align="center" >
            ...
            <a href="http://www.baidu.com">百度一下</a></div>
